...
try
{
    ...
    builder.Services.AddCors(options =>
    {
        ...
        {
            policy.WithOrigins("https://我是你爹.com", "https://*.我是你爹.com", "https://hoppscotch.io", "http://localhost:5000", "http://127.0.0.1:5000", "https://localhost:5001", "https://127.0.0.1:5001", "http://localhost:5258", "https://localhost:7258", "http://127.0.0.1:5258", "https://127.0.0.1:7258", "http://localhost:5500", "http://127.0.0.1:5500").AllowAnyHeader().AllowAnyMethod();
        });
    });
